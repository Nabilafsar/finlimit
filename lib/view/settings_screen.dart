...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _showEditProfileDialog(BuildContext context, SettingsViewModel vm) {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
                'Finlimit adalah aplikasi manajemen limit pengeluaran QRIS untuk membantu mengontrol keuangan harian dan bulanan.'),
            SizedBox(height: 12),
            Text('Dikembangkan untuk keperluan akademik.',
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(ctx);
              // Hubungkan ke LoginScreen milik Nabil:
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: label,
        prefixIcon:
            Icon(icon, color: const Color(0xFF2453E6), size: 20),
        filled: true,
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: const BorderSide(
              color: Color(0xFF2453E6), width: 1.5),
        ),
      ),
    );
  }
